...
-- This is particuarly useful if you expect to compile the same code using the
-- same constants in platforms using differerent machine sizes
#ifdef LIBSODIUM_JS_COMPAT
TN(CRYPTO_AEAD_CHACHA20POLY1305_IETF_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_aead_chacha20poly1305_ietf_messagebytes_max)
TN(CRYPTO_AEAD_CHACHA20POLY1305_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_aead_chacha20poly1305_messagebytes_max)
TN(CRYPTO_AEAD_XCHACHA20POLY1305_IETF_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_aead_xchacha20poly1305_ietf_messagebytes_max)
TN(CRYPTO_BOX_CURVE25519XCHACHA20POLY1305_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_box_curve25519xchacha20poly1305_messagebytes_max)
TN(CRYPTO_BOX_CURVE25519XSALSA20POLY1305_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_box_curve25519xsalsa20poly1305_messagebytes_max)
TN(CRYPTO_BOX_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_box_messagebytes_max)
TN(CRYPTO_PWHASH_ARGON2ID_MEMLIMIT_MAX, 2147483648, CSize, crypto_pwhash_argon2id_memlimit_max)
TN(CRYPTO_PWHASH_ARGON2I_MEMLIMIT_MAX, 2147483648, CSize, crypto_pwhash_argon2i_memlimit_max)
TN(CRYPTO_PWHASH_MEMLIMIT_MAX, 2147483648, CSize, crypto_pwhash_memlimit_max)
TN(CRYPTO_PWHASH_SCRYPTSALSA208SHA256_BYTES_MAX, 4294967295, CSize, crypto_pwhash_scryptsalsa208sha256_bytes_max)
TN(CRYPTO_PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_MAX, 4294967295, CSize, crypto_pwhash_scryptsalsa208sha256_memlimit_max)
TN(CRYPTO_PWHASH_SCRYPTSALSA208SHA256_PASSWD_MAX, 4294967295, CSize, crypto_pwhash_scryptsalsa208sha256_passwd_max)
TN(CRYPTO_SECRETBOX_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_secretbox_messagebytes_max)
TN(CRYPTO_SECRETBOX_XCHACHA20POLY1305_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_secretbox_xchacha20poly1305_messagebytes_max)
TN(CRYPTO_SECRETBOX_XSALSA20POLY1305_MESSAGEBYTES_MAX, 4294967279, CSize, crypto_secretbox_xsalsa20poly1305_messagebytes_max)
TN(CRYPTO_SECRETSTREAM_XCHACHA20POLY1305_MESSAGEBYTES_MAX, 4294967278, CSize, crypto_secretstream_xchacha20poly1305_messagebytes_max)
TN(CRYPTO_SIGN_ED25519_MESSAGEBYTES_MAX, 4294967231, CSize, crypto_sign_ed25519_messagebytes_max)
TN(CRYPTO_SIGN_MESSAGEBYTES_MAX, 4294967231, CSize, crypto_sign_messagebytes_max)
TN(CRYPTO_STREAM_CHACHA20_IETF_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_chacha20_ietf_messagebytes_max)
TN(CRYPTO_STREAM_CHACHA20_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_chacha20_messagebytes_max)
TN(CRYPTO_STREAM_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_messagebytes_max)
TN(CRYPTO_STREAM_SALSA2012_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_salsa2012_messagebytes_max)
TN(CRYPTO_STREAM_SALSA208_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_salsa208_messagebytes_max)
TN(CRYPTO_STREAM_SALSA20_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_salsa20_messagebytes_max)
TN(CRYPTO_STREAM_XCHACHA20_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_xchacha20_messagebytes_max)
TN(CRYPTO_STREAM_XSALSA20_MESSAGEBYTES_MAX, 4294967295, CSize, crypto_stream_xsalsa20_messagebytes_max)
#else
